...
public class Reuniao {
    ...
    public void mostraSobreposicao(){
        ...
        if(disponibilidadeEmComum != null){
            ...
            System.out.println("\n Todos os participantes estarao disponiveis para a reuniao no dia " + strDataInicio + 
            " ate " + strDataFim + "Periodo: " + periodo + " horas" );
        }else{

            System.out.println("\n Nao foi possivel encontrar um horario em comum para todos os participantes ");
        }
}
